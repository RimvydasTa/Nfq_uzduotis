...
<form action="" method="post" id="order-show-form">
    ...
    <input name="sortBy-inp" class="sortBy-inp" type="text" hidden value="<?php if (isset($_POST['sortBy-inp'])) echo $_POST['sortBy-inp']; ?>">
    <input name="sort-inp" class="sort-inp" type="text" hidden value="<?php if (isset($_POST['sort-inp'])) echo $_POST['sort-inp']; ?>">
